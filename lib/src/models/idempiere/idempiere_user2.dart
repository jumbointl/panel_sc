...
IdempiereUser2 idempiereUser2FromJson(String str) => IdempiereUser2.fromJson(json.decode(str));

String idempiereUser2ToJson(IdempiereUser2 data) => json.encode(data.toJson());

class IdempiereUser2 extends IdempiereObject{
  ...
  factory IdempiereUser2.fromJson(Map<String, dynamic> json) => IdempiereUser2(
    id: json["id"],
    name: json["name"],
  ...
  static List<IdempiereUser2> fromJsonList(List<dynamic> list){
    List<IdempiereUser2> newList =[];
    for (var item in list) {
      if(item is IdempiereUser2){
        newList.add(item);
      } else {
        IdempiereUser2 idempiereUser2 = IdempiereUser2.fromJson(item);
        newList.add(idempiereUser2);
      }
