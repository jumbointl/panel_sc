...
import 'package:solexpress_panel_sc/src/pages/seller/home/seller_orders_list_all_uncompleted_controller.dart';

import '../../../data/memory.dart';
import '../../../models/order.dart';
import '../../../models/order_status.dart';
import '../../../utils/relative_time_util.dart';
class SellerHomeOrdersListAllUncompletedPage2 extends OrderListPageModel{

  SellerOrdersListAllUncompletedController controller = Get.put(SellerOrdersListAllUncompletedController());

  SellerHomeOrdersListAllUncompletedPage2({super.key});
