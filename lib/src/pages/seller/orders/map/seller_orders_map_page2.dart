...
import 'seller_orders_map_controller2.dart';

class SellerOrdersMapPage2 extends StatelessWidget {

  SellerOrdersMapController2 con = Get.put(SellerOrdersMapController2());
  Completer<GoogleMapController> mapController = Completer();

  SellerOrdersMapPage2({super.key});
  @override
  Widget build(BuildContext context) {
    con.context = context;
    return GetBuilder<SellerOrdersMapController2> (
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: con.isLoading.value ? CircularProgressIndicator() :Text(
      ...
      child: Row(
        children: [
          IconButton(
            ...
            onPressed: con.isLoading.value ? null : con.isClose == true ? () => con.updateOrderToDelivered(context,con.order)
                : () =>{
              con.showErrorMessages(Messages.MUST_BE_WITHIN_PREDETERMINED_DISTANCE),
            },
