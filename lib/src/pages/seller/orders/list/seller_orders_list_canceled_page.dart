...
import 'package:solexpress_panel_sc/src/pages/seller/orders/list/seller_orders_list_canceled_controller.dart';

import '../../../../data/memory.dart';
import '../../../../models/order.dart';
import '../../../../models/order_status.dart';
class SellerOrdersListCanceledPage extends OrderListPageModel{

  SellerOrdersListCanceledController controller = Get.put(SellerOrdersListCanceledController());

  SellerOrdersListCanceledPage({super.key}){
