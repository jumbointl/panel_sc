...
import 'package:solexpress_panel_sc/src/pages/seller/orders/list/seller_orders_list_shipped_controller.dart';

import '../../../../data/memory.dart';
import '../../../../models/order.dart';
import '../../../../models/order_status.dart';
class SellerOrdersListShippedPage extends OrderListPageModel{

  SellerOrdersListShippedController controller = Get.put(SellerOrdersListShippedController());

  SellerOrdersListShippedPage({super.key}){
