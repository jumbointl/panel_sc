...
import 'package:solexpress_panel_sc/src/pages/seller/orders/list/seller_orders_list_returned_controller.dart';

import '../../../../data/memory.dart';
import '../../../../models/order.dart';
import '../../../../models/order_status.dart';
class SellerOrdersListReturnedPage extends OrderListPageModel{

  SellerOrdersListReturnedController controller = Get.put(SellerOrdersListReturnedController());

  SellerOrdersListReturnedPage({super.key}){
