...
import 'client_orders_list_delivered_controller.dart';
class ClientOrdersListDeliveredPage extends OrderListPageModel{

  ClientOrdersListDeliveredController controller = Get.put(ClientOrdersListDeliveredController());
  ClientOrdersListDeliveredPage({super.key}){
    controller = Get.put(ClientOrdersListDeliveredController());
