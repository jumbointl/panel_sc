...
import 'package:solexpress_panel_sc/src/pages/client/orders/list/client_orders_list_returned_controller.dart';
import 'package:solexpress_panel_sc/src/pages/common/order_list_page_model.dart';
import '../../../../data/memory.dart';
import '../../../../models/order.dart';
import '../../../../models/order_status.dart';
class ClientOrdersListReturnedPage extends OrderListPageModel{

  ClientOrdersListReturnedController controller = Get.put(ClientOrdersListReturnedController());
  ClientOrdersListReturnedPage({super.key}){
