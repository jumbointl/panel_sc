...
import 'client_orders_list_shipped_controller.dart';
class ClientOrdersListShippedPage extends OrderListPageModel{

  ClientOrdersListShippedController controller = Get.put(ClientOrdersListShippedController());
  ClientOrdersListShippedPage({super.key}){
