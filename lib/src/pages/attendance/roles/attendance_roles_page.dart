...
import 'attendance_roles_controller.dart';
import '../../../data/messages.dart';
import '../../../models/rol.dart';

class AttendanceRolesPage extends StatelessWidget {

  AttendanceRolesController con = Get.put(AttendanceRolesController());

  AttendanceRolesPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: con.roles.map((Rol rol) {return _cardRol(rol);}).toList(),
        ),
      ),
    );
  }
