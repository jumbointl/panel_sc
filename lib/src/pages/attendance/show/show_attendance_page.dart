...
class ShowAttendancePage extends StatelessWidget {
  ...
  final double defaultLogoHeight = MemoryPanelSc.EVENT_PANEL_LOGO_HEIGHT;
  final double defaultLogoWidth = MemoryPanelSc.EVENT_PANEL_LOGO_WIDTH;
  ...
  Widget build(BuildContext context) {
    ...
    if(con.screenColumns==1){
      ...
      con.fontSizeBig = MemoryPanelSc.fontSizeMedium;
    }else{
          ...
          child:  Obx(()=>Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                showTotalAttendance(context, con.attendanceByGroups),
                SizedBox(height: 10,),
                SizedBox(
  ...
  Widget showTotalAttendance(BuildContext context, List<AttendanceByGroup> attendanceByGroups) {
    ...
    MemoryPanelSc.EVENT_PANEL_LOGO_HEIGHT = 70;
    MemoryPanelSc.EVENT_PANEL_LOGO_WIDTH = 70;
  ...
  Widget showTotalAttendanceLandscape(BuildContext context, List<AttendanceByGroup> attendanceByGroups) {
    ...
    // let int total = attendanceByGroups total
    total = attendanceByGroups.fold(0, (sum, item) => sum + (item.total ?? 0));
    MemoryPanelSc.EVENT_PANEL_LOGO_HEIGHT = 120;
    MemoryPanelSc.EVENT_PANEL_LOGO_WIDTH = 120;
    return Container(
      width: double.infinity,
      margin: EdgeInsets.symmetric(horizontal: 20),
      decoration: BoxDecoration(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      width: width*0.4-MemoryPanelSc.EVENT_PANEL_LOGO_WIDTH-70,
                      child: Text(
