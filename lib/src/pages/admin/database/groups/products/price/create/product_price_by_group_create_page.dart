...
import 'product_price_by_group_create_controller.dart';
...
class ProductPriceByGroupCreatePage extends StatelessWidget {
  ProductPriceByGroupCreateController controller = Get.put(ProductPriceByGroupCreateController());

  ProductPriceByGroupCreatePage({super.key});
  ...
  Widget _dropDownGroups(List<Group> groups) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:  controller.groupsList.isEmpty ? Colors.white : resultColor ,  // Set the desired background color
  ...
  Widget _dropDownProducts(List<Product> products) {
    return Container(
      ...
      margin: EdgeInsets.only(top: 10, bottom: 10,left: 10,right: 10),
      decoration: BoxDecoration(
        color:  controller.productsList.isEmpty ? Colors.white : resultColor ,  // Set the desired background color
        borderRadius: BorderRadius.circular(15),
      ),
      child: DropdownButton(
        ...
        onChanged: (option) {
          if(controller.idProduct.value!=option.toString()){
            controller.idProduct.value = option.toString();
            controller.idController.text ='';
          }
  ...
  Widget _dropDownCategories(List<Category> categories) {
    return Container(
      ...
      margin: EdgeInsets.only(top: 10, bottom: 10,left: 10,right: 10),
      decoration: BoxDecoration(
        color:  controller.categoriesList.isEmpty ? Colors.white : dropDownColor ,  // Set the desired background color
        borderRadius: BorderRadius.circular(15),
      ),
      child: DropdownButton(
  ...
  Widget _buttomCreate(BuildContext context){
    return Container(
      ...
      child: ElevatedButton(onPressed: ()=> controller.priceCreate(context),
        ...
        children: [
          ConstrainedBox(
              ...
              child: IconButton(
                ...
                iconSize: iconSize,
                onPressed: () {
                  controller.findProductsBySqlCondition(context);
                },
              )
          ),
