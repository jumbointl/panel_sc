...
import 'package:solexpress_panel_sc/src/pages/panel_sc_roles/panel_sc_roles_controller.dart';
import '../../data/memory.dart';
import '../../models/host.dart';
import '../../models/idempiere/idempiere_tenant.dart';
import '../../data/messages.dart';

class PanelScRolesPage extends StatelessWidget {

  PanelScRolesController con = Get.put(PanelScRolesController());
  Color selectedColor = Colors.amber[200]!;

  PanelScRolesPage({super.key});
