...
import 'delivery_orders_list_returned_controller.dart';

class DeliveryOrdersListReturnedPage extends OrderListPageModel{
  DeliveryOrdersListReturnedController controller
                    = Get.put(DeliveryOrdersListReturnedController());

  DeliveryOrdersListReturnedPage({super.key}){
    isLoading = controller.isLoading ;
  }

  @override
  dynamic getActionButtons(){
    return <IconButton>[controller.buttonHome(),controller.buttonHistory(),controller.buttonDeclined()];
  }
