...
import 'delivery_orders_list_canceled_controller.dart';

class DeliveryOrdersListCanceledPage extends OrderListPageModel{
  DeliveryOrdersListCanceledController controller
                    = Get.put(DeliveryOrdersListCanceledController());

  DeliveryOrdersListCanceledPage({super.key}){
    isLoading = controller.isLoading ;
  }

  @override
  dynamic getActionButtons(){
    return <IconButton>[controller.buttonHome(),controller.buttonReturn(),controller.buttonHistory()];
  }
