...
import 'idempiere_tenant_with_details_list_for_user_controller.dart';
class IdempiereTenantWithDetailsListPage extends IdempiereObjectsListPageModel{

  IdempiereTenantWithDetailsListForUserController controller = Get.put(IdempiereTenantWithDetailsListForUserController());
  IdempiereTenantWithDetailsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.TENANT_WITH_DETAILS;}
  @override
