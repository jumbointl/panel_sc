...
import 'idempiere_tenant_with_details_home_controller.dart';

class IdempiereTenantWithDetailsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereTenantWithDetailsHomeController controller = Get.put(IdempiereTenantWithDetailsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereTenantWithDetailsHomePage({super.key}){
