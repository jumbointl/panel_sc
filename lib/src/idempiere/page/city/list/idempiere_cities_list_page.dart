...
import 'idempiere_cities_list_for_user_controller.dart';
class IdempiereCitiesListPage extends IdempiereObjectsListPageModel{

  IdempiereCitiesListForUserController controller = Get.put(IdempiereCitiesListForUserController());
  IdempiereCitiesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.CITIES;}
  @override
