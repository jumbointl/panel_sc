...
import 'idempiere_cities_home_controller.dart';

class IdempiereCitiesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereCitiesHomeController controller = Get.put(IdempiereCitiesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereCitiesHomePage({super.key}){
