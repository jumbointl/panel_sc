...
import 'idempiere_price_lists_list_for_user_controller.dart';
class IdempierePriceListsListPage extends IdempiereObjectsListPageModel{

  IdempierePriceListsListForUserController controller = Get.put(IdempierePriceListsListForUserController());
  IdempierePriceListsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.PRICE_LISTS;}
  @override
