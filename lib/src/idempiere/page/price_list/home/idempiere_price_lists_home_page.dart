...
import 'idempiere_price_lists_home_controller.dart';

class IdempierePriceListsHomePage extends IdempiereFilterCreatePageModel{
  final IdempierePriceListsHomeController controller = Get.put(IdempierePriceListsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempierePriceListsHomePage({super.key}){
