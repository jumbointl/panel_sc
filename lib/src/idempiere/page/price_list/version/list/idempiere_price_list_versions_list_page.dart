...
import 'idempiere_price_list_versions_list_for_user_controller.dart';
class IdempierePriceListVersionsListPage extends IdempiereObjectsListPageModel{

  IdempierePriceListVersionsListForUserController controller = Get.put(IdempierePriceListVersionsListForUserController());
  IdempierePriceListVersionsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.PRICE_LIST_VERSION;}
  @override
