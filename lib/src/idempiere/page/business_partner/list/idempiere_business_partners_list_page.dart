...
import 'idempiere_business_partners_list_for_user_controller.dart';
class IdempiereBusinessPartnersListPage extends IdempiereObjectsListPageModel{

  IdempiereBusinessPartnersListForUserController controller = Get.put(IdempiereBusinessPartnersListForUserController());
  IdempiereBusinessPartnersListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.BUSINESS_PARTNER;}
  @override
