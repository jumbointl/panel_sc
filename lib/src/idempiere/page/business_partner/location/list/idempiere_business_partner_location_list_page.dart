...
import 'idempiere_business_partners_locations_list_for_user_controller.dart';
class IdempiereBusinessPartnerLocationsListPage extends IdempiereObjectsListPageModel{

  IdempiereBusinessPartnerLocationsListForUserController controller = Get.put(IdempiereBusinessPartnerLocationsListForUserController());
  IdempiereBusinessPartnerLocationsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.BUSINESS_PARTNER_LOCATION;}
  @override
