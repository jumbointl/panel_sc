...
import 'idempiere_business_partners_home_controller.dart';

class IdempiereBusinessPartnersHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereBusinessPartnersHomeController controller = Get.put(IdempiereBusinessPartnersHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereBusinessPartnersHomePage({super.key}){
