...
class IdempiereUOMListForUserController extends IdempiereObjectsListControllerModel {



  IdempiereUOMListForUserController(){
    List<IdempiereUOM> list = getSavedIdempiereUOMList();
    if(list.isNotEmpty){
