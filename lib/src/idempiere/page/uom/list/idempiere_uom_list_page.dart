...
import 'idempiere_uom_list_for_user_controller.dart';
class IdempiereUOMListPage extends IdempiereObjectsListPageModel{

  IdempiereUOMListForUserController controller = Get.put(IdempiereUOMListForUserController());
  IdempiereUOMListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.UOM;}
  @override
