...
import 'idempiere_uom_home_controller.dart';

class IdempiereUOMHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereUOMHomeController controller = Get.put(IdempiereUOMHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereUOMHomePage({super.key}){
