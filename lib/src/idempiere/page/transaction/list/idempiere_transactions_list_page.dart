...
import 'idempiere_transactions_list_for_user_controller.dart';
class IdempiereTransactionsListPage extends IdempiereObjectsListPageModel{

  IdempiereTransactionsListForUserController controller = Get.put(IdempiereTransactionsListForUserController());
  IdempiereTransactionsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.TRANSACTIONS;}
  @override
