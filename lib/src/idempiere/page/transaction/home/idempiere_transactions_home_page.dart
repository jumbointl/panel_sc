...
import 'idempiere_transactions_home_controller.dart';

class IdempiereTransactionsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereTransactionsHomeController controller = Get.put(IdempiereTransactionsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereTransactionsHomePage({super.key}){
