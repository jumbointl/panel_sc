...
import 'idempiere_products_prices_list_for_user_controller.dart';
class IdempiereProductsPricesListPage extends IdempiereObjectsListPageModel{

  IdempiereProductsPricesListForUserController controller = Get.put(IdempiereProductsPricesListForUserController());
  IdempiereProductsPricesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.PRODUCTS_PRICES;}
  @override
