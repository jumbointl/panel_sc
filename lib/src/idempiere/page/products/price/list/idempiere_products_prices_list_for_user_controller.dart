...
class IdempiereProductsPricesListForUserController extends IdempiereObjectsListControllerModel {



  IdempiereProductsPricesListForUserController(){
    List<IdempiereProductPrice> list = getSavedIdempiereProductsPricesList();
    if(list.isNotEmpty){
