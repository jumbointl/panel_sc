...
import 'idempiere_products_prices_home_controller.dart';

class IdempiereProductsPricesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereProductsPricesHomeController controller = Get.put(IdempiereProductsPricesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereProductsPricesHomePage({super.key}){
