...
import 'idempiere_products_brands_list_for_user_controller.dart';
class IdempiereProductsBrandsListPage extends IdempiereObjectsListPageModel{

  IdempiereProductsBrandsListForUserController controller = Get.put(IdempiereProductsBrandsListForUserController());
  IdempiereProductsBrandsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.PRODUCTS_BRANDS;}
  @override
