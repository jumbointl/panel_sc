...
import 'idempiere_products_categories_home_controller.dart';

class IdempiereProductsCategoriesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereProductsCategoriesHomeController controller = Get.put(IdempiereProductsCategoriesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereProductsCategoriesHomePage({super.key}){
