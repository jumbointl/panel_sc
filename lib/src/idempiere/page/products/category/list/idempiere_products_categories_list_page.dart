...
import 'idempiere_products_categories_list_for_user_controller.dart';
class IdempiereProductsCategoriesListPage extends IdempiereObjectsListPageModel{

  IdempiereProductsCategoriesListForUserController controller = Get.put(IdempiereProductsCategoriesListForUserController());
  IdempiereProductsCategoriesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.CATEGORIES;}
  @override
