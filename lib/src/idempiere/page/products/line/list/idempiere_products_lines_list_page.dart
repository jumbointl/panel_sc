...
import 'idempiere_products_lines_list_for_user_controller.dart';
class IdempiereProductsLinesListPage extends IdempiereObjectsListPageModel{

  IdempiereProductsLinesListForUserController controller = Get.put(IdempiereProductsLinesListForUserController());
  IdempiereProductsLinesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.PRODUCTS_LINES;}
  @override
