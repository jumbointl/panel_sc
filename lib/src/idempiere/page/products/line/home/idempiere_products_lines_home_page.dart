...
import 'idempiere_products_lines_home_controller.dart';

class IdempiereProductsLinesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereProductsLinesHomeController controller = Get.put(IdempiereProductsLinesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereProductsLinesHomePage({super.key}){
