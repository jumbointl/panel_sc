...
import 'idempiere_products_home_controller.dart';

class IdempiereProductsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereProductsHomeController controller = Get.put(IdempiereProductsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereProductsHomePage({super.key}){
  ...
  void findByCondition(BuildContext context) {
    ...
    print('findByCondition------------------------${controller.idempiereFilters.length}');
