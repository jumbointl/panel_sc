...
import 'idempiere_currencies_home_controller.dart';

class IdempiereCurrenciesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereCurrenciesHomeController controller = Get.put(IdempiereCurrenciesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereCurrenciesHomePage({super.key}){
