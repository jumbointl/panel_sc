...
import 'idempiere_currencies_list_for_user_controller.dart';
class IdempiereCurrenciesListPage extends IdempiereObjectsListPageModel{

  IdempiereCurrenciesListForUserController controller = Get.put(IdempiereCurrenciesListForUserController());
  IdempiereCurrenciesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.CURRENCIES;}
  @override
