...
import 'idempiere_user_with_details_list_for_user_controller.dart';
class IdempiereUserWithDetailsListPage extends IdempiereObjectsListPageModel{

  IdempiereUserWithDetailsListForUserController controller = Get.put(IdempiereUserWithDetailsListForUserController());
  IdempiereUserWithDetailsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.USER_WITH_DETAILS;}
  @override
