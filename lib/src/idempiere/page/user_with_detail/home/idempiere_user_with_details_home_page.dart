...
import 'idempiere_user_with_details_home_controller.dart';

class IdempiereUserWithDetailsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereUserWithDetailsHomeController controller = Get.put(IdempiereUserWithDetailsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereUserWithDetailsHomePage({super.key}){
