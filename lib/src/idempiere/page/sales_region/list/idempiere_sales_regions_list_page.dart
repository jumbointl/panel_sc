...
import 'idempiere_sales_regions_list_for_user_controller.dart';
class IdempiereSalesRegionsListPage extends IdempiereObjectsListPageModel{

  IdempiereSalesRegionsListForUserController controller = Get.put(IdempiereSalesRegionsListForUserController());
  IdempiereSalesRegionsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.SALES_REGIONS;}
  @override
