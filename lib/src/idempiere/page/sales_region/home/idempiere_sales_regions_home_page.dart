...
import 'idempiere_sales_regions_home_controller.dart';

class IdempiereSalesRegionsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereSalesRegionsHomeController controller = Get.put(IdempiereSalesRegionsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereSalesRegionsHomePage({super.key}){
