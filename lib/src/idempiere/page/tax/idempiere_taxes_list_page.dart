...
import 'idempiere_taxes_list_for_user_controller.dart';
class IdempiereTaxesListPage extends IdempiereObjectsListPageModel{

  IdempiereTaxesListForUserController controller = Get.put(IdempiereTaxesListForUserController());
  IdempiereTaxesListPage({super.key});
