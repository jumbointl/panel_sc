...
import 'idempiere_taxes_categories_home_controller.dart';

class IdempiereTaxesCategoriesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereTaxesCategoriesHomeController controller = Get.put(IdempiereTaxesCategoriesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereTaxesCategoriesHomePage({super.key}){
