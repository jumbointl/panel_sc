...
import 'idempiere_Taxes_categories_list_for_user_controller.dart';
class IdempiereTaxesCategoriesListPage extends IdempiereObjectsListPageModel{

  IdempiereTaxesCategoriesListForUserController controller = Get.put(IdempiereTaxesCategoriesListForUserController());
  IdempiereTaxesCategoriesListPage({super.key});
