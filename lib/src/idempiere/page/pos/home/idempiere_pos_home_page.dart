...
import 'idempiere_pos_home_controller.dart';

class IdempierePOSHomePage extends IdempiereFilterCreatePageModel{
  final IdempierePOSHomeController controller = Get.put(IdempierePOSHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempierePOSHomePage({super.key}){
