...
import 'idempiere_pos_list_for_user_controller.dart';
class IdempierePOSListPage extends IdempiereObjectsListPageModel{

  IdempierePOSListForUserController controller = Get.put(IdempierePOSListForUserController());
  IdempierePOSListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.POS;}
  @override
