...
import 'idempiere_organizations_home_controller.dart';

class IdempiereOrganizationsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereOrganizationsHomeController controller = Get.put(IdempiereOrganizationsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereOrganizationsHomePage({super.key}){
