...
import 'idempiere_organizations_list_for_user_controller.dart';
class IdempiereOrganizationsListPage extends IdempiereObjectsListPageModel{

  IdempiereOrganizationsListForUserController controller = Get.put(IdempiereOrganizationsListForUserController());
  IdempiereOrganizationsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.ORGANIZATIONS;}
  @override
