...
import 'idempiere_contries_home_controller.dart';

class IdempiereCountriesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereCountriesHomeController controller = Get.put(IdempiereCountriesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereCountriesHomePage({super.key}){
