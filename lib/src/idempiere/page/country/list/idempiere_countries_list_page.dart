...
import 'idempiere_countries_list_for_user_controller.dart';
class IdempiereCountriesListPage extends IdempiereObjectsListPageModel{

  IdempiereCountriesListForUserController controller = Get.put(IdempiereCountriesListForUserController());
  IdempiereCountriesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.COUNTRIES;}
  @override
