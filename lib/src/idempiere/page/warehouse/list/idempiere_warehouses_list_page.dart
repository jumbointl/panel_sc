...
import 'idempiere_warehouses_list_for_user_controller.dart';
class IdempiereWarehousesListPage extends IdempiereObjectsListPageModel{

  IdempiereWarehousesListForUserController controller = Get.put(IdempiereWarehousesListForUserController());
  IdempiereWarehousesListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.WAREHOUSES;}
  @override
