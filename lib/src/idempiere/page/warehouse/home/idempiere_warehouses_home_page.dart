...
import 'idempiere_warehouses_home_controller.dart';

class IdempiereWarehousesHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereWarehousesHomeController controller = Get.put(IdempiereWarehousesHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereWarehousesHomePage({super.key}){
