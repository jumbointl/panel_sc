...
import 'idempiere_regions_home_controller.dart';

class IdempiereRegionsHomePage extends IdempiereFilterCreatePageModel{
  final IdempiereRegionsHomeController controller = Get.put(IdempiereRegionsHomeController());
  Color hoverColor = Colors.amber[200]!;
  IdempiereRegionsHomePage({super.key}){
