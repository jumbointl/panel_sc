...
import 'idempiere_regions_list_for_user_controller.dart';
class IdempiereRegionsListPage extends IdempiereObjectsListPageModel{

  IdempiereRegionsListForUserController controller = Get.put(IdempiereRegionsListForUserController());
  IdempiereRegionsListPage({super.key});
  ...
  @override
  String getTitle() { return Messages.REGIONS;}
  @override
