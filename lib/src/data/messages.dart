...
class Messages{
  ...
  static String CLOCK_RIGHT_MARGIN_ADJUSTMENT='MARGEN DERECHO DEL RELOJ';
  ...
  static String CLOSING_PLEASE_WAIT='CERRANDO, FAVOR ESPERAR...';

  static String SELECT_A_CONFIGURATION='SELECCIONAR UNA CONFIGURACION';

  static String NOT_SAVED_CHANGES='NO HAY CAMBIOS GUARDADOS';
  static String NOT_CHANGES='NO HAY CAMBIOS';

  static String NO_INTERNET_CONNECTION_AFTER_RETRIES='NO HAY CONECCION DEL INTERNET, DESPUES DE INTENTOS';

  static String RETRYING_CONNECTION='INTENTANDO DE CONECTAR';

  static String WAIT_FOR_DATA='ESPERANDO DATOS';

  static String POS_CREATE='CREAR POS';

  static String POS_HANDLING='MANIPULAR POS';

  static String EVENT_CREATE='CREAR EVENTO';

  static String EVENT_HANDLING='MANIPULAR EVENTO';

  static String EVENT_CONFIG_CREATE='CREAR CONFIG DE EVENTO';

  static String EVENT_CONFIG_HANDLING='MANIPULAR CONFIG DE EVENTO';

  static String POS_OF_EVENT_CREATE='CREAR POS DE EVENTO';

  static String POS_OF_EVENT_HANDLING='MANIPULAR POS DE EVENTO';

  static String CREATE='CREAR';

  static String SOL_EXPRESS_EVENT='SOL EXPRESS EVENT';

  static String START_DATE = 'INICIO';
  static String END_DATE = 'FIN';

  static String NO_ROWS_AFFECTED='NO HAY REGISTROS AFECTADOS';
  ...
  static String SETTINGS='CONFIGURACIONES';

  static String DATABASE_URL_WITHOUT_HTTP='BASE DE DATOS URL SIN http://';

  static String DB_HOST='BASE DE DATOS SERVIDOR';

  static String SHOW_CONFIGURATION = 'MOSTRAR CONFIGURACION';

  static String HIDE_CONFIGURATION='OCULTAR CONFIGURACION';

  static String EVENTS='EVENTOS';

  static String FUNCTION='FUNCION';

  static String CREATE_WITH_ID ='CREAR CON ID';

  static String PLACES='LUGARES';

  static String EVENT_HAS_POS='POS DEL EVENTO';

  static String SELECT_POS='SELECCIONAR POS';

  static String FIND_EVENT_BY_NAME ='BUSCAR EVENTO POR NOMBRE';
  static String FIND_POS_BY_NAME ='BUSCAR POS POR NOMBRE';

  static String EVENT_ID='ID DE EVENTO';
  static String POS_ID='ID DE POS';
  static String DELETE_DATA='BORRAR DATOS';

  static String CONFIG_ID='ID DE CONFIG';

  static String FIND_CONFIG_BY_NAME='BUSCAR POR NOMBRE DE CONFIG';

  static String BARCODE_LENGTH ='LONGITUD DE CODIGO DE BARRAS';

  static String PLACE_ID_LENGTH='LONGITUD DE ID DE LUGAR';

  static String TIME_OFFSET_MINUTES='TIEMPO DE DESPLAZAMIENTO UTC(MINUTOS)';

  static String SHOW_PROGRESS_BAR_EACH_X_TIMES='MOSTRAR BARRA DE PROGRESO CADA X VECES';

  static String EVENT_DATE ='FECHA DE EVENTO';

  static String LOGO='LOGO';

  static String LANDING_PAGE='PAGINA PRINCIPAL';

  static String NO_IMAGE_FOUND='NO HAY IMAGEN ENCONTRADA';

  static String ERROR_DATABASE_TRANSACTION ='ERROR DE TRANSACCION DE BASE DE DATOS';

  static String FIND_CONFIG_BY_NAME_FOR_TEMPLATE='BUSCAR CONFIG POR NOMBRE PARA PLANTILLA';

  static String NO_CONFIG_TO_CREATE='NO HAY CONFIGURACION PARA CREAR';

  static String SELECT_A_DATE_TO_CREATE='SELECCIONAR UNA FECHA PARA CREAR';

  static String NO_DATA_TO_CREATE='NO HAY DATOS PARA CREAR';

  static String SELECT_A_TEMPLATE='SELECCIONAR UNA PLANTILLA';

  static String NO_TEMPLATE_FOUND='NO HAY PLANTILLAS ENCONTRADAS';

  static String DATE_AVAILABLE='FECHA DISPONIBLE';

  static String NO_DATE_AVAILABLE='NO HAY FECHAS DISPONIBLES';

  static String PRESS_TO_ADD_DATE='PRESIONE PARA AGREGAR FECHA';
  static String TO_ADD_DATE='AGREGAR FECHA';

  static String NOT_DATE_SELECTED='NO SELECCIONO FECHA';


  static String minimumCharacters(int minimumCharacters) {
    return 'MÍNIMO $minimumCharacters CARACTERES';
  }
